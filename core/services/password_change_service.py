...
def validate_current_password(user, contrasenia_actual):
    """Valida que la contraseña actual sea correcta"""
    if not check_password(contrasenia_actual, user.password):
        return False, "Contraseña incorrecta"
    return True, None

def validate_new_password(contrasenia_actual, contrasenia_nueva):
...
def change_password(user, contrasenia_nueva):
